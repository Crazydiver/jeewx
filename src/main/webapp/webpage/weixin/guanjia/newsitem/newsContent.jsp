...
<link rel="stylesheet" type="text/css"
	href="plug-in/weixin/core/wx-article/client-page1e4a15.css">
<!--[if lt IE 9]>
...
<link media="screen and (min-width:1000px)" rel="stylesheet"
	type="text/css" href="plug-in/weixin/core/wx-article/pc-page1ea1b6.css">
<style>
body {
...
<body id="activity-detail">
	<img width="12px" style="position: absolute; top: -1000px;"
		src="plug-in/weixin/core/wx-article/ico_loading1984f1.gif">
	<div class="wrp_page">
		<div class="page-bizinfo">
			<div class="header">
				<h1 id="activity-name">${newsItem.title}</h1>
				<p class="activity-info">
					<span id="post-date" class="activity-meta no-extra"> <fmt:formatDate
							value='${newsItem.createDate}' type="date" pattern="yyyy-MM-dd" />
					</span>  <a
						href="javascript:viewProfile();" id="post-user"
						class="activity-meta"> <span class="text-ellipsis">
							${newsItem.author} </span> <i class="icon_link_arrow"> </i>
					</a>
				</p>
			</div>
		</div>
